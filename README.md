...
Phase 3 has started with reusable metadata, loudness, and dynamics extraction, including embedded file metadata (for example ID3/Vorbis/FLAC tags), and the tagging layer now includes path-based tag extraction.
