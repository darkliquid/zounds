...
Phase 3 has started with reusable metadata, spectral, beat, pitch, loudness, and dynamics extraction, including embedded file metadata (for example ID3/Vorbis/FLAC tags), and the tagging layer now includes path-based tag extraction.
