...
Phase 3 has started with reusable metadata, spectral, beat, pitch, MFCC, loudness, and dynamics extraction, plus consolidated feature-vector building, including embedded file metadata (for example ID3/Vorbis/FLAC tags), and the tagging layer now includes path-based tag extraction.
